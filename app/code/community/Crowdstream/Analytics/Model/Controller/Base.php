<?php
abstract class Crowdstream_Analytics_Model_Controller_Base
{
    protected $_name;
    protected $_data;
    ...
    {
        $key = Mage::helper('crowdstream_analytics')->getWriteKey();    
        $block = $this->getLayout()->createBlock('crowdstream_analytics/template')
        ->setTemplate('crowdstream_analytics/'.$this->getName().'.phtml')
        ->setKey($key);
