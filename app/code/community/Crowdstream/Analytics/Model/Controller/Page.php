<?php
class Crowdstream_Analytics_Model_Controller_Page extends Crowdstream_Analytics_Model_Controller_Base
{
    ...
    {    
        ...
        $title = Mage::helper('crowdstream_analytics')->getNormalizedPageTitle($title);
