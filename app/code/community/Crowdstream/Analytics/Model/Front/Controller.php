...
*/
class Crowdstream_Analytics_Model_Front_Controller
{
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Crowdstream_Analytics_Model_Front_Controller;
        }
    ...
    {
        return Mage::getSingleton('crowdstream_analytics/session');
    }
