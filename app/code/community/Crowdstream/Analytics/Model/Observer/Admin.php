<?php
class Crowdstream_Analytics_Model_Observer_Admin
{
    public function addExplainationTextToConfigScreen($observer)
    {
        ...
        if($action->getRequest()->getParam('section') !== 'crowdstream_analytics')
        {
            return;
        }
...
//         ->setTemplate('crowdstream_analytics/welcome-container.phtml')
//         ->setContentJson($json);
